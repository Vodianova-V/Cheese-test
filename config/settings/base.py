...
DATABASES = {
    ...
    "default": env.db(
        "DATABASE_URL",
        default="postgres://postgres:1111@localhost:5432/everycheese",
    )
}
...
LOCAL_APPS = [
    ...
    'ech.cheeses.apps.CheesesConfig',
...
MIGRATION_MODULES = {
    "sites": "ech.contrib.sites.migrations"
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "ech.utils.context_processors.settings_context",
            ],
        },
    }
]
...
SOCIALACCOUNT_ADAPTER = (
    "ech.users.adapters.SocialAccountAdapter"
)
